...
> **历史记录，非当前安全结论**：本报告原文记录早期公开准备过程（包含 2026-06-07 的产物及后来补记），没有连续覆盖后续提交。下方“当前”“已清零”“可以发布”等表述仅指原检查时点。v1.3.x 的使用边界见[本版说明](./RELEASE-GUIDE-v1.3.md)，2026-09-13 的依赖审计仍有 9 个受影响依赖项，详见[SECURITY.md](../SECURITY.md#依赖审计状态)。不能把本报告当作当前上线或安全认证。

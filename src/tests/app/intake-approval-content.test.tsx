...
describe("立案详情人工核查展示", () => {
  ...
  it("无检索时不能显示无冲突结论", () => {
    render(<IntakeApprovalContent detail={{ sections: [], rounds: [], currentParties: [], checks: [] }} />);
  ...
  it("展开相同、相似和证件结果，具体结果先于结论", () => {
    ...
    render(<IntakeApprovalContent view="conflicts" detail={{ sections: [], rounds: [], currentParties: [{ role: "OPPOSING_PARTY", name: "本案测试对方", idNumber: "" }], checks: [{

...
export function IntakeActions({ intakeId, status, canApprove = false, canResubmit = false }: {
  ...
  return <div className="flex flex-wrap items-center gap-3">
    <p className="t-xs t-mute">{status === "NEEDS_REVISION" ? "补充材料后，可在审批工作台重新提交。" : "审批进度与处理记录统一在工作台查阅。"}</p>
    <Button size="sm" variant={canApprove || canResubmit ? "default" : "secondary"} asChild>
